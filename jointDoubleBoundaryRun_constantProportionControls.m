function [controlFailureTrack1, controlFailureTrack2] = jointDoubleBoundaryRun_constantProportionControls(folderName, fileName, pStruct, constProp)
...
%GENERAL RULES
    ...
    options = odeset('RelTol', 1e-4, 'NonNegative', [1 2 3 4 5]);
    [t, x] = ode45(@(t, x) jointBoundaryEqn_constantProportionControls(t, x, p, constProp), tSPAN, x(end,:), options);
