function maxThreshBreak = multirun_uMaxB_uSingA(uMax, kR, folderBase)
    ...
    for q = 1:length(ratio_2naught_3naught)
        ...
        %establish population
         ...
         %pop struct & file names
            ...
            figureName = sprintf('%sindividualuMaxBuSingA/test_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
            ...
            figureName2 = sprintf('%sindividualuMaxBuSingA/concentration_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
