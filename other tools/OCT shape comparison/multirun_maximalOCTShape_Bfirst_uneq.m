function [failureTime, switchpoint] = multirun_maximalOCTShape_Bfirst_uneq(uMax, kR, folderBase)
    ...
    %         thresholdBreak = controlFailureTrack2;
        ...
        figureName = sprintf('%sindividualMaxMaxB_uneq/test_x2x3ratio%s_gammaUnequal.fig', folderName, num2str(ratio_2naught_3naught(q)));
        ...
        Store.x=[Store.x; x(2:end,:)];
            ...
            title('Plot of cell populations - Max/Max B First', 'FontSize', 24);
        ...
        figureName2 = sprintf('%sindividualMaxMaxB_uneq/concentration_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
