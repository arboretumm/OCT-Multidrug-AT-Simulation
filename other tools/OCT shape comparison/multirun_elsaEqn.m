function maxThreshBreak = multirun_elsaEqn(uMax, kR, folderBase)
    ...
    for q = 1:length(ratio_2naught_3naught)
        %establish population
         ...
         %pop struct & file names
            ...
            figureName = sprintf('%sindividualElsaEqual/test_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
        ...
        for i = 1:length(concCalcBStart)
            ...
            figureName2 = sprintf('%sindividualElsaEqual/concentration_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
