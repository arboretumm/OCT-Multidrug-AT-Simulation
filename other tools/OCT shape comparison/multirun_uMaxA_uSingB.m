function maxThreshBreak = multirun_uMaxA_uSingB(uMax, kR, folderBase)
...
%population params that are staying the same
    ...
    %ratios for looping through
        ...
        finalTimepoints = zeros(1, length(ratio_2naught_3naught));
    ...
    for q = 1:length(ratio_2naught_3naught)
        ...
        %establish population
         ...
         %pop struct & file names
            ...
            figureName = sprintf('%sindividualuMaxAuSingB/test_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
            ...
            concA = ones(1, length(Store.t))*p.uMaxA;
            ...
            figureName2 = sprintf('%sindividualuMaxAuSingB/concentration_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
