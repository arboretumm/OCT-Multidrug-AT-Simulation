function [failureTime, switchpoint] = multirun_maximalOCTShape(uMax, kR, folderBase)
    ...
    %         thresholdBreak = controlFailureTrack2;
        ...
        figureName = sprintf('%sindividualMaxMaxA/test_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
        ...
        figureName2 = sprintf('%sindividualMaxMaxA/concentration_x2x3ratio%s_gammaEqual.fig', folderName, num2str(ratio_2naught_3naught(q)));
