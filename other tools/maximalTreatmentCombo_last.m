function [thresholdBreak] = maximalTreatmentCombo_last(popStructFile, runFile, saveFile, drugConcA, drugConcB, timestep)
        ...
        options = odeset('RelTol', 1e-4, 'NonNegative', [1 2 3 4 5]);
        [t, x] = ode45(@(t, x) practicalityEquations(t, x, p, timeVector, concAVec, concBVec), tSPAN, x(end,:), options);
