function [thresholdBreak] = practicalityAnalysisJoints (popStructFile, runFile, saveFile, timestep, constProp, dosingIncrement)
    ...
    %stepwise treatment regimen -- play w/floor v ceiling rounding?
        ...
        roundedConcB = ceil(interpConcB/acc)*acc;
            ...
            strFileName2 = sprintf('%s%s%s.png', saveFile, "_drugConcentrationApprox");
    ...
    %previous simulation with new simulation & fail time
        ...
        %GRAPHING
            ...
            strFileName4 = sprintf('%s%s%s.png', saveFile, "_cellPopulationApproxTx");
