function [controlFailureTrack1, controlFailureTrack2] = jointDoubleBoundaryRun_constantProportionControls_last(folderName, fileName, pStruct, constProp)
...
%     concentrationB = constProp*concentrationA;
    ...
    savefig(gcf2,strFileName5); %saves population graph as fig
    ...
    savefig(gcf3,strFileName7); %saves population graph as fig
    ...
    savefig(gcf4,strFileName9); %saves population graph as fig
