function [controlFailureTrack1, controlFailureTrack2] = sequentialDoubleBoundaryRunA_subPopSwitch_last(folderName, fileName, pStruct, populationNum, populationLim)
