function [controlFailureTrack1, controlFailureTrack2] = sequentialDoubleBoundaryRunB_concDrugEarlySwitch_withAOption_arrSave_(folderName, fileName, pStruct, drugConc1, drugConc2)
        ...
        %sprintf("phase 1 done")
            if t(end) < tSPAN(end)
                ...
                if t(end) < tSPAN(end)
                    ...
                    [t, x] = ode45(@(t, x) controlAMax_controlBMax(t, x, p), [t(end-1) tSPAN(end)], x(end,:), options3);
