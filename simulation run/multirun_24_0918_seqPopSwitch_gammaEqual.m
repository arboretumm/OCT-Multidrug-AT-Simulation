function multirun_24_0918_seqPopSwitch_gammaEqual(uMax, kR, folderBase)
tic
%population set up
...
heatvectorVals = zeros(length(ratio_2naught_3naught));
    ...
    for i=1:length(ratio_2naught_3naught)
        ...
        [failureTime4, failureTime5] = sequentialDoubleBoundaryRunA_subPopSwitch(folderName, fileName, popStruct, 5, kappa_threshold+1);
