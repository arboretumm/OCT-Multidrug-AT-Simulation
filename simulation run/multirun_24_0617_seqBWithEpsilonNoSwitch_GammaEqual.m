function multirun_24_0617_seqBWithEpsilonNoSwitch_GammaEqual(uMax, kR, folderBase)
tic
%population set up
...
save(vectorName, "ratio_2naught_3naught", "epsilon");
    ...
    for i=1:length(ratio_2naught_3naught)
        ...
        [failureTime4, failureTime5] = sequentialDoubleBoundaryRunB_concDrugSwitch_withAOption_arrSave(folderName, fileName, popStruct, altMaxA, altMaxB);
