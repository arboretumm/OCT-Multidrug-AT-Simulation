function [controlFailureTrack1, controlFailureTrack2] = sequentialDoubleBoundaryRunA_subPopSwitch_WEIRD(folderName, fileName, pStruct, populationNum, populationLim)
