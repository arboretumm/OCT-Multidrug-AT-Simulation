function [controlFailureTrack1, controlFailureTrack2] = sequentialDoubleBoundaryRunB_subPopSwitch_WEIRD(folderName, fileName, pStruct, populationNum, populationLim)
