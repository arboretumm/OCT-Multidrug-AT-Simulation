function [controlFailureTrack1, controlFailureTrack2] = sequentialDoubleBoundaryRunB_concDrugSwitch_withAOption_arrSave(folderName, fileName, pStruct, drugConc1, drugConc2)
