function [controlFailureTrack1, controlFailureTrack2] = sequentialDoubleBoundaryRunB_subPopSwitch_last_WEIRD(folderName, fileName, pStruct, populationNum, populationLim)
...
%GENERAL RULES
    ...
    if t(end) < tSPAN(end)
        ...
        if t(end) < tSPAN(end)
            ...
            options2 = odeset('Events', @(t, x) eventMaxB_Amax(t, x, p), 'RelTol', 1e-4, 'NonNegative', [1 2 3 4]);
