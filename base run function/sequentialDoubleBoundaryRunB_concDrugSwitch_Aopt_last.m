function [controlFailureTrack1, controlFailureTrack2] = sequentialDoubleBoundaryRunB_concDrugSwitch_Aopt_last(folderName, fileName, pStruct, drugConc1, drugConc2)
